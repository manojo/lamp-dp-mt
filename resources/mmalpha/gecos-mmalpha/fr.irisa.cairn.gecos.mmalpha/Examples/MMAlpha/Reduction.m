...
(* $Id: Reduction.m *)
Reduction::usage =
"Package. Contains transformations to deal with reduction operators."

serializeReduce::usage = 

"serializeReduce[pos, spec_String] serializes the reduction at
...
Clear[redundantQ];
redundantQ[m:Alpha`matrix[r_,c_,_,mat_]] := (identityQ[m] || (Drop[mat,-1]==Table[0,{i,r-1},{j,c}]));
...
(* is currently not finished, it appears to be very complicated in 
   ...
   able to restructuratie the ast will algebraic rules *)

...
/**
 * This is the item provider adapter for a {@link fr.irisa.cairn.model.mathematica.BuiltInNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuiltInNodeItemProvider
	 ...
	 * @generated
	 */
	public BuiltInNodeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BuiltInNode_keyword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BuiltInNode_keyword_feature", "_UI_BuiltInNode_type"),
				 MathematicaPackage.Literals.BUILT_IN_NODE__KEYWORD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MathematicaPackage.Literals.BUILT_IN_NODE__CHILDREN);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BuiltInNode"));
	}
	...
	public String getText(Object object) {
		String label = ((BuiltInNode)object).getKeyword();
		return label == null || label.length() == 0 ?
			getString("_UI_BuiltInNode_type") :
			getString("_UI_BuiltInNode_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BuiltInNode.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MathematicaPackage.Literals.BUILT_IN_NODE__CHILDREN,

...
Module[ {trsystemName, trparamDecl, trinputDeclList, troutputDeclList, trlocalDeclList, trequationBlock, tr$systemName, tr$paramDecl, tr$inputDeclList, tr$outputDeclList, tr$localDeclList, tr$equationBlock},
  Catch[
    ...
    semanticFunc[system, trparamDecl, trinputDeclList, troutputDeclList, trlocalDeclList, trequationBlock, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
CheckCellTranslateDECLARATION[ x:decl[varName_, varType_, domain_], opts:___Rule ] :=
Module[ {trvarName, trvarType, trdomain, tr$varName, tr$varType, tr$domain},
  Catch[
      ...
      trvarName = varName;
      If[ MatchQ[ varType, _Symbol ],Null, Throw[ Message[ CheckCellTranslateDECLARATION::error1,varType, x] ] ];
      trvarType = varType;
      trdomain = CheckCellTranslateDOMAIN[ domain, opts ];
    semanticFunc[decl, decl[varName, varType, domain], debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trdimension, trindexList, trpolyedronList, tr$dimension, tr$indexList, tr$polyedronList},
  Catch[
    ...
    semanticFunc[domain, dimension, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trleftHandSide, trrightHandSide, tr$leftHandSide, tr$rightHandSide},
  Catch[
    ...
    semanticFunc[assignment, trrightHandSide, equation[leftHandSide, rightHandSide], debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {traffExpression, traffineFunction, tr$affExpression, tr$affineFunction},
  Catch[
    ...
    semanticFunc[affexp, traffExpression, affineFunction, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
CheckCellTranslateBINEXP[ x:binop[binaryOp:(add | sub | mul | div | or | and | xor | min | max | eq | ne | le | lt | gt | minus | div | mod), operand1_, operand2_], opts:___Rule ] :=
Module[ {trbinaryOp, troperand1, troperand2, tr$binaryOp, tr$operand1, tr$operand2},
  Catch[
      If[ MatchQ[ binaryOp, add | sub | mul | div | or | and | xor | min | max | eq | ne | le | lt | gt | minus | div | mod ],Null, Throw[ Message[ CheckCellTranslateBINEXP::error1,binaryOp, x] ] ];
      trbinaryOp = binaryOp;
      troperand1 = CheckCellTranslateSUBEXPRESSION[ operand1, opts ];
      troperand2 = CheckCellTranslateSUBEXPRESSION[ operand2, opts ];
    semanticFunc[binop, troperand1, troperand2, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trexpressionList, tr$expressionList},
  Catch[
    ...
    semanticFunc[case, trexpressionList, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trdomain, trifExpression, tr$domain, tr$ifExpression},
  Catch[
    ...
    semanticFunc[restrict, trdomain, trifExpression, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trifCondition, tralt1, tralt2, tr$ifCondition, tr$alt1, tr$alt2},
  Catch[
    ...
    semanticFunc[if, trifCondition, ifCondition, tralt1, alt1, tralt2, alt2, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trexpression, traffineFunction, tr$expression, tr$affineFunction},
  Catch[
      ...
      traffineFunction = CheckCellTranslateMATRIX[ affineFunction, opts ];
    semanticFunc[controlexpression, expression, affineFunction, debug -> CheckCellDebug]  ] (* End Catch *)
]; (* End Module *)
...
Module[ {trdomain, trrestExpression, tr$domain, tr$restExpression},
  Catch[
    ...
    {domain, restExpression}  ] (* End Catch *)
]; (* End Module *)

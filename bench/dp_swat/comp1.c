...
extern "C" {
#endif
JNIEXPORT jobject JNICALL Java_CompWrapper1_parse(JNIEnv* env, jobject obj, jcharArray input1, jcharArray input2);
JNIEXPORT jobject JNICALL Java_CompWrapper1_backtrack(JNIEnv* env, jobject obj, jcharArray input1, jcharArray input2);
#ifdef __cplusplus
}
#endif
...
jobject Java_CompWrapper1_parse(JNIEnv* env, jobject obj, jcharArray input1, jcharArray input2) {
  struct timeval ts,te; double delta;
  gettimeofday(&ts,NULL);
  input_t *in1=NULL; jni_read(env,input1,&in1);
  input_t *in2=NULL; jni_read(env,input2,&in2);
  g_init(in1,in2); free(in2);  gettimeofday(&te,NULL);
...
jobject Java_CompWrapper1_backtrack(JNIEnv* env, jobject obj, jcharArray input1, jcharArray input2) {
  struct timeval ts,te; double delta;
  gettimeofday(&ts,NULL);
  input_t *in1=NULL; jni_read(env,input1,&in1);
  input_t *in2=NULL; jni_read(env,input2,&in2);

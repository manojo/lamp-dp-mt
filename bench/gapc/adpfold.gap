...
EXAMPLE guacgucaguacguacgugacugucagucaac

HEADER
<h1>Minimum free energy secondary structure prediction</h1>

One major use case for dynamic programming in bioinformatics is
<a target="_blank"
href="http://en.wikipedia.org/wiki/Nucleic_acid_secondary_structure">RNA
secondary structure</a> prediction. This algorithm computes the
structure with the <a target="_blank"
href="http://en.wikipedia.org/wiki/Principle_of_minimum_energy">minimum
free energy (MFE)</a>. It uses the same energy parameters as <a
target="_blank"
href="http://www.tbi.univie.ac.at/~ivo/RNA/RNAfold.html">RNAfold</a>
(with parameters <tt>-noLP -d2</tt>).

...
function [] = mbp()
	...
	do_graph('zuker.eps','Zuker',D,axis,[1,2,6,7,10,11],{'-k','--k','-rd','-gx','-bs','-mo'},{'ViennaRNA','ADP fusion','CPU','CPU+BT','GPU','GPU+BT'})
	do_graph('nussinov.eps','Nussinov',D,axis,[3,4,5,8,9],{'-k','-rd','-gx','-bs','-mo'},{'LMS','CPU','CPU+BT','GPU','GPU+BT'})

...
\item Problem: folding a RNA string $S$ over itself $|S|=n$ by minimizing the free energy (which is based on actual measurements, hereby much more complicated than Nussinov \S\ref{nussinov}).

...
\item Ultimately, the dynamic programming algebra and grammar were formalized into a specific language \cite{gapl} provided with an ad-hoc compiler \cite{gapc_thesis}, hereby allowing more advanced analysis of the grammar \cite{gapc_yield}.
\ule

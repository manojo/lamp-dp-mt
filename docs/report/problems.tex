...
Since <<dynamic programming>> defines a very general technique, we already focused on grammar and alignment problems in \ref{intro_dp}. Before exploring some particular problem instances, we want to define some characteristics that will be used through the rest of the document to describe dynamic programming problems.
...
% ----------------------------------------------
\newpage
\subsubsection{Zuker RNA folding}\ol

...
\item Grammar embedded in Scala (DSL) to express DP problems concisely
...
\item Systematic approach to generate and process data (top-down/bottom-up) and backtracking information (focus on running time and memory efficiency)

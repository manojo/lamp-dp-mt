...
\href{http://en.wikipedia.org/wiki/Longest_common_substring_problem\#Pseudocode}{Longest common substring} & rectangle & 1 & -- \\
...
\href{http://en.wikipedia.org/wiki/CYK_algorithm}{Cocke-Younger-Kasami (CYK)} & triangle & \#rules & -- \\
...
{\color{red}
Other algorithms to consider/process:\ul
...
\item \href{http://en.wikipedia.org/wiki/Needleman-Wunsch_algorithm}{Needleman-Wunsch} (sequences alignement)
\ule
See more in comments
}

Other algorithms used in bioinformatics, including sequence alignment, structural alignment, RNA structure prediction.

% PROBLEM LISTS
% I guess we need between 20-50 DP problems to demonstrate that we identified almost all types of problems.
...
The serial problem have the interesting property to access to a fixed number of previous elements. These elements 


propose a memory consumption scheme

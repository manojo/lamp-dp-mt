...
\begin{center}\setlength{\unitlength}{.6cm}\begin{picture}(8,9)
	...
	\Cg{0,6}
	\Cg{0,5} \Cg{1,5}
	\Cg{0,4} \Cg{1,4} \Cg{2,4}
	\Cg{0,3} \Cg{1,3} \Cg{2,3} \Cg{3,3}
	\Cg{0,2} \Cg{1,2} \Cg{2,2} \Cg{3,2} \Cg{4,2}
	\Cg{0,1} \Cg{1,1} \Cg{2,1} \Cg{3,1} \Cg{4,1} \Cg{5,1}
	\Cg{0,0} \Cg{1,0} \Cg{2,0} \Cg{3,0} \Cg{4,0} \Cg{5,0} \Cg{6,0}

	\Cz{0,7}\Cz{1,6}\Cz{2,5}\Cz{3,4}\Cz{4,3}\Cz{5,2}\Cz{6,1}\Cz{7,0}
...
\item Problem: find an optimal parenthesizing of the multiplication of $n$ matrices $A_i$. Each matrix $A_i$ is of dimension $r_i \times c_i$ \textit{<<r=rows, c=columns>>}. 
...
{\color{red}
\item Recurrence for the cost matrix:
...
\item Problem: folding a RNA string $S$ over itself.
{\color{red}
\item Matrices: XXX
\item Alphabets:\ul

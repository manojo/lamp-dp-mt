...
\item Optimizations:\ul
	...
	XXX: what's the best trade off ? progress towards bottom right VS map indices more efficiently ? Also consider efficient memory usage$\to$ larger problem VS standardized layout}
	\ule
\ole
...
\item Visualisation: \begin{center}\includegraphics[width=7cm]{problems_zucker.pdf}\end{center}

...
\textbf{User-language}: Windowing, input sizes, alphabet, recurrence functions, devices available, what to keep in memory (cost, backtrack or both). \\
